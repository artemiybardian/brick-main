...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='Obj',
            fields=[
                ('id', models.CharField(max_length=12, primary_key=True, serialize=False, verbose_name='Идентификатор')),
        ...
        migrations.CreateModel(
            name='Alternate',
            fields=[
                ('id', models.OneToOneField(db_column='id', on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='database.obj', verbose_name='Основной объект')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('item', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='images', to='database.obj', verbose_name='Объект')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('color', models.TextField(verbose_name='Цвет')),
                ('part', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='links_as_part', to='database.obj', verbose_name='Часть')),
                ('set', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='links_as_set', to='database.obj', verbose_name='Набор')),
            ],
            options={
                'verbose_name': 'Связь',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('high', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='high_links', to='database.theme', verbose_name='Родительская коллекция')),
                ('low', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='low_links', to='database.theme', verbose_name='Дочерняя коллекция')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('high', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='theme_obj_links', to='database.theme', verbose_name='Коллекция')),
                ('obj', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='theme_obj_links', to='database.obj', verbose_name='Объект')),
            ],
            options={
